...
const VideoTitle = ({title,overview}) => {
  return (
    <div className=' w-screen aspect-video pt-[10%]  md:pl-[5%] px-12  absolute md:bg-gradient-to-r md:from-black  text-white mt-[70%] md:mt-[0%]
    bg-black md:bg-transparent'>
      <h1 className='font-bold  pl-4 md:pl-0 text-lg -mt-[50%] md:mt-[15%] md:text-2xl'>{title.length >=40 ? title.substr(40):title}</h1>
